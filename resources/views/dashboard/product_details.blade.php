...
<form action="{{route('create_new_details')}}" method="get">
<h1 class="alert">تفاصيل المنتجات</h1>
 <div class="card">
    <div class="card-body">
    <div class="row">
 ...
 <div class="row mt-3">
  <div class="col">
     <label for="category" class="form-label" >تصنيف المنتج</label>
   <input type="text" class="form-control" id="category" name="category" placeholder=" must be 'electric' or 'homeFurniture'">
  </div>
 </div>
