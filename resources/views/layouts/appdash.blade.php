                    ...
                    <div
                        ...
                        <a href="/" class=" text-white text-decoration-none">
                            <i class="fs-4 bi-speedometer2"></i> <span
                                class="fs-5 d-none d-sm-inline text-center p-1">لوحة التحكم</span>
                        </a>
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link align-start text-white px-0">
                                    <i class="fs-4 bi-house text-white"></i> <span
                                        class="ms-1 d-none d-sm-inline p-1">الرئيسية</span>
                                </a>
                            </li>

                            <li>
                                <a href="{{ route('products') }}" class="nav-link px-0 align-middle">
                                    <i class="fs-4 bi-table text-white p-2"></i> <span
                                        class="ms-1 d-none d-sm-inline text-white">المنتجات</span></a>
                            </li>

                            <li>
                                <a href="{{ route('showdet') }}" class="nav-link px-0 align-middle">
                                    <i class="fs-4 bi-grid text-white p-2"></i> <span
                                        class="ms-1 d-none d-sm-inline text-white">تفاصيل المنتجات</span> </a>

                            </li>
                            <li>
                                <a href="#" class="nav-link px-0 align-middle">
                                    <i class="fs-4 bi-people text-white"></i> <span
                                        class="ms-1 d-none d-sm-inline text-white"><b>العملاء</b></span> </a>
                            </li>
                        </ul>
                        <hr>
